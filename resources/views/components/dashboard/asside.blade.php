<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="collapse navbar-collapse  w-auto h-auto" id="sidenav-collapse-main">
        @php
        // Function to create a safe ID from the name
        ...
        <ul class="navbar-nav">
            <li class="nav-item">
                <a href="#dashboardsExamples" class="nav-link {{ request()->is('dashboards') ? 'active' : '' }}"
            ...
            <li class="nav-item">
                ...
                <a data-bs-toggle="collapse" href="#{{ $mmId }}" class="nav-link {{ $isActive ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">{{ $mm->name }}</span>
                </a>
                {{-- Sub Menu --}}
